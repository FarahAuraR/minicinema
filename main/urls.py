...
from main.views import show_main, create_item, show_xml, show_json, show_xml_by_id, show_json_by_id,add_item, reduce_item, remove_item, get_item_json, add_item_ajax
